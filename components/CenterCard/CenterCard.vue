		...
		.scroll-view_H {
			...
			.scroll-view-item_H {
				...
				.card__info {
					...
					color: white;
					line-height: 1.5;
					background: linear-gradient(to bottom, rgba(128, 128, 128, 0.5) 0%, rgba(128, 128, 128, 0) 50%);
